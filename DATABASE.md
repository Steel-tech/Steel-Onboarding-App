...
|------------|-------------|----------|-----------|------|-------------|
| employee_data | user_id | users | id | many-to-one | Each employee belongs to one user account |
| onboarding_progress | user_id | users | id | many-to-one | Progress records linked to user accounts |
