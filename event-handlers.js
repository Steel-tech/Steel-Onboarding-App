...
Flawless Steel Welding Onboarding System`;
        ...
        // Create mailto link
        const mailtoLink = `mailto:hr@flawlesssteelwelding.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
                ...
                modal.innerHTML = `
                    <div class="modal-content">
                        ...
                        <div class="email-details">
                            <p><strong>To:</strong> hr@flawlesssteelwelding.com</p>
